...
class Deck:
    def __init__(self, name):
        ...
        self.states = {"Forge": {"Interdimensional Graft":False}, "House": {"Control the Weak":False}, "Play": {"Library Access":False, "Phase Shift":[False], "Scrambler Storm":False, "Soft Landing":False}, "Fight": {"Warsong":[False], "Foggify":False, "Skippy Timehog":False}, "Buff": {}, "Destroyed":{"Loot the Bodies":[False]}, "Reap": {"Dimension Door":False, "Skippy Timehog":False}, "Action": {"Skippy Timehog":False}}
        self.pendingDest = []
